...
const LandingPage = () => {
    ...
    return (
        <div className='h-full' style={{ backgroundImage: `url(${BackgroundImage})` }}>
            ...
            <div className='pt-32 px-4 bg-[#FDF7EB] bg-opacity-75'>
            ...
            <div className='w-full px-3 flex gap-5 mt-16'>
                <div
                    ...
                    <p className="text-base sm:text-lg text-center">Criar lista de compras</p>
                </div>
                <div
                    ...
                    <p className='text-base sm:text-lg text-center'>Acessar lista de compras</p>
                </div>
            </div>
            <div className="w-full flex flex-col items-center py-7 mt-16 bg-[#FDF7EB] bg-opacity-80">
